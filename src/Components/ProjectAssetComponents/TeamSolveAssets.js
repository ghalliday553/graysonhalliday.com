                ...
                <Carousel interval={null} indicators={false}>
                    <Carousel.Item>
                        <video style={{display: "block", margin: "auto", height: "500px" }} controls>
                            <source src="./ProjectAssets/TeamSolve/TeamSolveDemo_V2.mp4"></source>
                        </video>
                    </Carousel.Item>
                    <Carousel.Item>
                    ...
                    <Carousel.Item>
                        <img style={{display: "block", margin: "auto", height: "500px" }} src="./ProjectAssets/TeamSolve/FullScreenImage.jpeg" alt="image"></img>
                    </Carousel.Item>
                    <Carousel.Item>
