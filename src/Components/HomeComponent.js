            ...
            <div>
                ...
                <p className="HelloContainer">
                    <p className="HelloContainerText">
                        ...
                        <p className="HelloText">My name is Grayson Halliday and I am an electrical engineering graduate of the University of Victoria. Although my interests currently lie within networking and machine learning, I am always looking to expand my breadth of knowledge and tackle new projects.</p>
