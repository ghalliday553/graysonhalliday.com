...
class ProjectComponent extends React.Component {
    constructor(props) {
        ...
        this.teamSolve = {
            ...
            projectOverviewText: ["Designed to promote collaboration and improve team productivity by facilitating problem-solving through individual problem contexts.",
        ...
        this.NHLBetting = {
            ...
            projectOverviewText: ["Machine learning system with the ability to predict NHL game victors.",
                                "The system analyses both common and advanced statistics associated with each teams' previous sequence of games using a Long Short-Term Memory (LSTM) Recurrent Neural Network (RNN).", "In validating the model on the 2021 NHL season using historical moneyline bet values, a ~$5000 profit was earned while placing $100 bets on each predicted victor."],
        ...
        this.fatigueDetection = {
            ...
            projectOverviewText: ["Fatigue detection system utilizing EEG data to infer if an individual is fit to perform a task.",
                                "The system utilized a Long Short-Term Memeory (LSTM) Recurrent Neural Network (RNN) to analyze a subject's brain frequency entropy. Testing results showed the system was able to correctly classify a nurse as either pre or post-shift with greater than 90% accuracy."],
